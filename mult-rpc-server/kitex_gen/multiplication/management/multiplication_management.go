...
func (p *MultiplicationRequest) GetFirstNum() (v int32) {
	return p.FirstNum
}

func (p *MultiplicationRequest) GetSecondNum() (v int32) {
	return p.SecondNum
}
func (p *MultiplicationRequest) SetFirstNum(val int32) {
	p.FirstNum = val
}
func (p *MultiplicationRequest) SetSecondNum(val int32) {
	p.SecondNum = val
}
...
func (p *MultiplicationRequest) Field1DeepEqual(src int32) bool {
...
func (p *MultiplicationRequest) Field2DeepEqual(src int32) bool {
...
type MultiplicationResponse struct {
	Product int32 `thrift:"Product,1" frugal:"1,default,i32" json:"Product"`
}
...
func (p *MultiplicationResponse) GetProduct() (v int32) {
	return p.Product
}
func (p *MultiplicationResponse) SetProduct(val int32) {
	p.Product = val
}
...
func (p *MultiplicationResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("Product", thrift.I32, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.Product); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *MultiplicationResponse) Field1DeepEqual(src int32) bool {
